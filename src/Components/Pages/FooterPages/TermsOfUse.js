...
export const TermsOfUse = () => {
    return (
        <PageContainer>
            ...
            <p> </p>
            <p>Este documento, e todo o conteúdo do site é oferecido por <strong>Dicionario de pleonasmos</strong>, neste termo representado apenas por "EMPRESA", que regulamenta todos os direitos e obrigações com todos que acessam o site, denominado neste termo como "VISITANTE", reguardado todos os direitos previstos na legislação, trazem as cláusulas abaixo como requisito para acesso e visita do mesmo, situado no endereço <strong>https://iikaro.github.io/pleonasm-dict/home.</strong></p>
            <p> </p>
